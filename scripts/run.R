...
oraclePartitions <- function(number_dataset, number_cores, number_folds, id_part, folderResults){
  ...
  cat("\n\n################################################################################################")
  cat("\n# Run: get labels")
  folder = paste(diretorios$folderDatasetFolds, "/NamesLabels", sep="")
  setwd(folder)
  ...
  timeComPart = system.time(resPart <- partition(id_part, ds, dataset_name, number_folds, namesLabels, folderResults)) 
  cat("\n\n################################################################################################")
