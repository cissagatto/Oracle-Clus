...
This code is part of my doctoral research at PPG-CC/DC/UFSCar. The aim is build, validate and test all possible partitions for multilabel classification using Clus Framework

## How to cite 
@misc{Gatto2022, author = {Gatto, E. C.}, title = {Oracle Partitions for Multilabel Classification with Clus}, year = {2022}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{}}}
...
01. libraries.R
02. utils.R
03. buildAndTestPartitions.R
04. evaluation.R
05. BestWorstPartitions.R
06. run.R
07. oracle.R
08. o_config_files.R
09. o_jobs.R
...
## RUN
To run the code, open the terminal, enter the */Oracle-Clus/R/* folder, and type

```
Rscript oracle.R [absolute_path_to_config_file]
```

Example:

```
Rscript oracle.R "~/Oracle-Clus/O-Config-Files/O-GpositiveGO.csv"
```
