...
#config_file = "/home/cissa/Oracle-Clus/O-Config-Files/O-GpositiveGO.csv"
...
while (id_part <= n) {
  ...
  write.csv(result_set, paste("Partition-", id_part, "-Runtime.csv", sep=""))
  ...
  # destino = paste("nuvem:Clus/Oracle/",
  #                 dataset_name, sep = "")
...
# destino = paste("nuvem:Clus/Oracle/",dataset_name, sep = "")
# comando = paste("rclone -P copy ", origem, " ", destino, sep = "")
# cat("\n", comando, "\n")
# a = print(system(comando))
# a = as.numeric(a)
...
cat("\n#######################################################################\n\n")
timeBMP = system.time(bestMeasuresPartitions(ds,
                                             dataset_name,
                                             number_dataset,
                                             number_cores,
                                             number_folds,
